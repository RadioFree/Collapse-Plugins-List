...
* Description: This is a simple plugin to improve the core of WordPress on the plugins admin page.  It collapses the list of plugins to make it easier to find plugins on mobile devices.   
* Version: 1.0
